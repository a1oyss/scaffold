 ...
 * @author hccake
 */
public class OpenApiStatusReplaceEnvironmentPostProcessor implements EnvironmentPostProcessor {
	...
	private static final String OPENAPI_ENABLED_KEY = OpenApiProperties.PREFIX + ".enabled";
	...
	public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
		...
		String ballcatOpenApiEnabledValue = environment.getProperty(OPENAPI_ENABLED_KEY);

package com.chaoxing.scaffold.autoconfigure.springdoc;
...
public class OpenApiProperties {
	...
	public static final String PREFIX = "scaffold.openapi";
	...
	public static class CorsConfig {
		 ...
		 * 允许跨域的方法列表
		 */
		private List<String> allowedMethods = Lists.newArrayList(CorsConfiguration.ALL);

		/**
		 * 允许跨域的头信息
		 */
		private List<String> allowedHeaders = Lists.newArrayList(CorsConfiguration.ALL);

		/**
		 * 额外允许跨域请求方获取的 response header 信息
		 */
		private List<String> exposedHeaders = Lists.newArrayList("traceId");
